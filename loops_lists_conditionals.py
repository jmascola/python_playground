...
# Update the password variable to take in an user input!

updated_password = input("Please enter a password: ")

# In the final check, use another if statement to list why it isn't a strong password!
